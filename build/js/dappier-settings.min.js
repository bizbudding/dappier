...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var agentDesc = document.getElementById('agent_desc');
  var agentPersona = document.getElementById('agent_persona');
  var agentNameInput = agentName.querySelector('input');
  var agentDescInput = agentDesc.querySelector('input');
  var agentPersonaInput = agentPersona.querySelector('input');
